...
class GazeboInterface():
	...
	def __init__(self):
		...
		self.joint_1_pub = rospy.Publisher('/joint_1_cntrl/command', Float64, queue_size=1)
		self.joint_2_pub = rospy.Publisher('/joint_2_cntrl/command', Float64, queue_size=1)
		self.joint_3_pub = rospy.Publisher('/joint_3_cntrl/command', Float64, queue_size=1)
		self.joint_4_pub = rospy.Publisher('/joint_4_cntrl/command', Float64, queue_size=1)
		self.joint_5_pub = rospy.Publisher('/joint_5_cntrl/command', Float64, queue_size=1)
		self.joint_6_pub = rospy.Publisher('/joint_6_cntrl/command', Float64, queue_size=1)
		self.joint_7_pub = rospy.Publisher('/joint_7_cntrl/command', Float64, queue_size=1)
